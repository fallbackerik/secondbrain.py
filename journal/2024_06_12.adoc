...
* xref:/note/LearningVsAcquisition.adoc[Learning vs Acquisition]
* xref:/note/subconsciousKnowledgeComesFromUnderstandingMessagesThatAreComprehensible.adoc[subconscious knowledge comes from understanding messages that are <<comprehensible>>]
...
* xref:/note/VocabularyAcquisitionIsDoneSubconsciouslyAndIncrementally.adoc[<<vocabulary acquisition>> is done subconsciously and incrementally]
